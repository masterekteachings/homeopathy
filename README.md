...
The learner homepage may identify an upcoming teaching series, but unfinished lecture rows are not exposed in the canonical Reader. Page-color preferences, reading-language preference and core navigation are shared across the learner site. Homepage language selection visibly localizes learner-facing interface copy and lecture topic cues while preserving the source course identifiers.
